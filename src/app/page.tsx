...
import { Sparkles, Heart, Code, Palette, Zap } from 'lucide-react';
...
<MacbookScroll/>
        ...
        <div className="min-h-screen w-full bg-gradient-to-br from-black via-purple-900/20 to-black relative overflow-hidden">
